# Copilot Instructions — `candidate-blueprism`
...
- **Authoritative path**: `/home/ssf/Documents/Github/candidate-blueprism` on the `alfares` server.
- **Origin**: `git@github.com:speakASAP/candidate-blueprism.git`, branch `main`.
...
3. This repo, in order: `BUSINESS.md` `SYSTEM.md` `AGENTS.md` `TASKS.md` `STATE.json`
