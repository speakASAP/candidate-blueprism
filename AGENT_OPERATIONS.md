# Agent Operations: candidate-blueprism
...
No repository-defined add operations derived from approved candidate-blueprism requirements
...
## Project-Specific Operations
Respect the existing Blue Prism candidate assessment runtime and use only its tracked operational interfaces.
